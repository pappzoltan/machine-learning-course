...
compareAUC(list(deep_small_model, tanh_model))
```
...
compareAUC(list(deep_small_model, more_epochs_model, higher_batch_size_model))
```
...
compareAUC(list(deep_small_model, dropout_model, input_dropout_model))
```
...
compareAUC(list(deep_small_model, regularized_model))
```
...
compareAUC(list(deep_small_model, early_stopping_model))
```
